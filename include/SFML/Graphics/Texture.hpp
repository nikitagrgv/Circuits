...
public:
    ...
    ///
    /// No additional check is performed on the size of the pixel
    /// array or the bounds of the area to placeNodes, passing invalid
...
/// to the texture in a single operation (see Texture::placeNodes).
///
...
///     ...
///
///     // placeNodes the texture
///     sf::Uint8* pixels = ...; // get a fresh chunk of pixels (the next frame of a movie, for example)
///     texture.placeNodes(pixels);
///
///     // draw it
///     window.draw(sprite);
///
